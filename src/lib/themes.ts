...
export const themes: Record<string, Theme> = {
  ...
  masterVariant: {
    name: 'Theme Master 1.1',
    colors: {
      primaryBlue: '#2D3142',
      primaryBlueDark: '#1a1a2e',
      primaryBlueLight: '#4F5D75',
      secondaryGray: '#9A8C98',
      secondaryGrayLight: '#C9ADA7',
      secondaryGrayDark: '#284B63',
      accentGreen: '#3C6E71',
      accentGreenLight: '#4a8a8c',
      accentOrange: '#3C6E71',
      accentOrangeLight: '#FFFFFF',
      accentRed: '#ef4444',
      accentRedLight: '#f87171',
      bgPrimary: '#FFFFFF',
      bgSecondary: '#F2E9E4',
