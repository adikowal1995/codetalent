      ...
      colors: [
        {
          ...
          hexCode: colors.primaryBlue,
        },
        {
          name: 'Primary Blue Dark',
          color: colors.primaryBlueDark,
          hexCode: colors.primaryBlueDark,
        },
        {
          name: 'Primary Blue Light',
          color: colors.primaryBlueLight,
          hexCode: colors.primaryBlueLight,
        },
      ],
    },
    {
      ...
      colors: [
        {
          ...
          hexCode: colors.secondaryGray,
        },
        {
          name: 'Secondary Gray Light',
          color: colors.secondaryGrayLight,
          hexCode: colors.secondaryGrayLight,
        },
        {
          name: 'Secondary Gray Dark',
          color: colors.secondaryGrayDark,
          hexCode: colors.secondaryGrayDark,
        },
      ],
    },
    {
      ...
      colors: [
        {
          ...
          hexCode: colors.accentGreen,
        },
        {
          name: 'Accent Green Light',
          color: colors.accentGreenLight,
          hexCode: colors.accentGreenLight,
        },
        {
          name: 'Accent Orange',
          color: colors.accentOrange,
          hexCode: colors.accentOrange,
        },
        {
          name: 'Accent Orange Light',
          color: colors.accentOrangeLight,
          hexCode: colors.accentOrangeLight,
        },
        {
          name: 'Accent Red',
          color: colors.accentRed,
          hexCode: colors.accentRed,
        },
        {
          name: 'Accent Red Light',
          color: colors.accentRedLight,
          hexCode: colors.accentRedLight,
        },
      ],
    },
    {
      ...
      colors: [
        {
          ...
          hexCode: colors.textPrimary,
        },
        {
          name: 'Text Secondary',
          color: colors.textSecondary,
          hexCode: colors.textSecondary,
        },
        {
          name: 'Text Tertiary',
          color: colors.textTertiary,
          hexCode: colors.textTertiary,
        },
        {
          name: 'Text Light',
          color: colors.textLight,
          hexCode: colors.textLight,
        },
        {
          name: 'Text Muted',
          color: colors.textMuted,
          hexCode: colors.textMuted,
        },
      ],
    },
  ];
    ...
    <div className="p-6 bg-white">
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="space-y-2 text-sm">
          <p>
            <code>import {'{ colors }'} from '../lib/colors';</code>
          </p>
          <p>
            <code>style={'{ backgroundColor: colors.primaryBlue }'}</code>
          </p>
          <p>
            <code>className="text-primary"</code> (using CSS variables)
          </p>
        </div>
      </div>
    </div>
