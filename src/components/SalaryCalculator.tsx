...
const SalaryCalculator = () => {
  ...
  > = {
    ...
    'PHP Developer': {
      Junior: {
        zdalna: { uop: [7000, 11000], b2b: [8750, 13125], baseCost: 14000 },
        hybrydowa: { uop: [6500, 10500], b2b: [7875, 12250], baseCost: 14000 },
        stacjonarna: {
          uop: [6000, 10000],
          b2b: [7000, 11375],
          baseCost: 14000,
    ...
    'Tester manualny': {
      Junior: {
        zdalna: { uop: [5000, 8000], b2b: [6125, 9625], baseCost: 10000 },
        hybrydowa: { uop: [4500, 7500], b2b: [5250, 8750], baseCost: 10000 },
        stacjonarna: { uop: [4000, 7000], b2b: [4375, 7875], baseCost: 10000 },
      },
      Mid: {
        zdalna: { uop: [8000, 12000], b2b: [9625, 14000], baseCost: 15000 },
        hybrydowa: { uop: [7500, 11000], b2b: [8750, 13125], baseCost: 15000 },
        stacjonarna: {
          uop: [7000, 10000],
          b2b: [7875, 12250],
          baseCost: 15000,
    ...
    'Tester automatyzujacy': {
      Junior: {
        zdalna: { uop: [7000, 11000], b2b: [8750, 13125], baseCost: 13000 },
        hybrydowa: { uop: [6500, 10500], b2b: [7875, 12250], baseCost: 13000 },
        stacjonarna: {
          uop: [6000, 10000],
          b2b: [7000, 11375],
          baseCost: 13000,
      ...
      Mid: {
        zdalna: { uop: [11000, 17000], b2b: [13125, 19250], baseCost: 18000 },
        hybrydowa: {
          uop: [10500, 16000],
          b2b: [12250, 18375],
          baseCost: 18000,
      ...
      Senior: {
        zdalna: { uop: [17000, 26000], b2b: [19250, 31500], baseCost: 27000 },
        hybrydowa: {
          uop: [16000, 24000],
          b2b: [18375, 29750],
          baseCost: 27000,
    ...
    'IT Administrator': {
      Junior: {
        zdalna: { uop: [6000, 9000], b2b: [7000, 10500], baseCost: 12000 },
        hybrydowa: { uop: [5500, 8500], b2b: [6125, 9625], baseCost: 12000 },
        stacjonarna: { uop: [5000, 8000], b2b: [5250, 8750], baseCost: 12000 },
      },
      Mid: {
        zdalna: { uop: [9000, 14000], b2b: [10500, 16625], baseCost: 17000 },
        hybrydowa: { uop: [8500, 13000], b2b: [9625, 15750], baseCost: 17000 },
        stacjonarna: {
          uop: [8000, 12000],
          b2b: [8750, 14875],
          baseCost: 17000,
      ...
      Senior: {
        zdalna: { uop: [14000, 22000], b2b: [16625, 28000], baseCost: 25000 },
        hybrydowa: {
          uop: [13000, 20000],
          b2b: [15750, 26250],
          baseCost: 25000,
    ...
    'Solution Architect': {
      Junior: {
        zdalna: { uop: [10000, 15000], b2b: [12250, 17500], baseCost: 18000 },
        hybrydowa: { uop: [9500, 14000], b2b: [11375, 16625], baseCost: 18000 },
        stacjonarna: {
          uop: [9000, 13000],
          b2b: [10500, 15750],
          baseCost: 18000,
      ...
      Mid: {
        zdalna: { uop: [15000, 22000], b2b: [17500, 26250], baseCost: 25000 },
        hybrydowa: {
          uop: [14000, 20000],
          b2b: [16625, 24500],
          baseCost: 25000,
      ...
      Senior: {
        zdalna: { uop: [22000, 35000], b2b: [26250, 43750], baseCost: 40000 },
        hybrydowa: {
          uop: [20000, 32000],
          b2b: [24500, 42000],
          baseCost: 40000,
  ...
  const calculateSalary = () => {
    ...
    if (workMode === 'hybrydowa') {
      ...
      recruitmentCost = Math.round(data.baseCost * 1.1);
    }
