    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 lg:mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 lg:mb-4" style={{ color: currentTheme.colors.textPrimary }}>
            Nasz proces rekrutacji
          </h2>
          <p className="text-base sm:text-lg lg:text-xl max-w-2xl mx-auto px-4" style={{ color: currentTheme.colors.textSecondary }}>
