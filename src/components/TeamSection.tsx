...
const TeamSection = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description:
        'Były frontend developer, który doskonale rozumie potrzeby techniczne kandydatów i wymagania projektów.',
    },
    {
      ...
      description:
        'Ekspertka w obszarze rekrutacji juniorów i QA. Pomaga młodym talentom w rozpoczęciu kariery w IT.',
    },
  ];
